...
rgba(80, 80, 80, ${item.hovered ? 0.3 : 0.6})), url('${item.imageUrl}')`,
    ...
    <a class="publish-container" href="">
      <div class="publish-cta">
        ¡Publica tu propiedad! <i class="fa-regular fa-circle-plus fa-lg"></i>
      </div>
    </a>
  </div>
</template>
...
const cardItems = ref([
  {
    ...
    link: "google.com",
    imageUrl: "homepage/luxury_house.jpg",
    hovered: false,
  },
  {
    typeOfProperty: "Apartamentos",
    link: "google.com",
    imageUrl: "homepage/apartment_interior.jpg",
    hovered: false,
  },
  {
    typeOfProperty: "Bodegas",
    link: "google.com",
    imageUrl: "homepage/warehouse.jpg",
    hovered: false,
  },
  {
    typeOfProperty: "Locales Comerciales",
    link: "google.com",
    imageUrl: "homepage/commercial_premise.jpg",
    hovered: false,
  },
]);
